...
// Australian private health funds that process HICAPS claims for remedial
// massage. "Other" lets clients enter a fund not on this list. Shared by the
// customer-facing confirm form and the staff walk-in / new-booking form so
// the dropdown stays consistent.
