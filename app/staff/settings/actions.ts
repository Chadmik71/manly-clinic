...
//
// Updates the singleton ClinicSetting row. Auth is enforced at the
// route layer (the /staff layout protects this URL); a follow-up commit
// will add a redundant session check here as defense in depth.
...
export async function updateClinicSettings(
  ...
  const { depositsEnabled, cardSurchargeEnabled, cardSurchargeBps } = input;
